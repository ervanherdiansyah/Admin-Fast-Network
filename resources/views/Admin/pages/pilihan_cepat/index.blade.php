...
@section('title', 'Pilihan Cepat Pencairan')
@section('css')
            ...
            <div class="col-12 ">
                <div class="card mb-4 ">
                    <div class="card-header pb-0">
                        <h6 class="d-lg-none">Pilihan Cepat Pencairan</h6>
                        <div class="d-flex align-items-center">
                            <h6 class="d-none d-lg-block">Pilihan Cepat Pencairan</h6>
                            <div class="d-flex flex-wrap align-items-center ms-auto gap-2">
                                ...
                                <button type="button" class="btn btn-primary btn-sm ms-auto" data-bs-toggle="modal"
                                    ...
                                    Tambah Pilihan Cepat Pencairan
                                </button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $item->nominal }}</h6>
        ...
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/admin/pilihan-cepat/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="example-text-input" class="form-control-label">Nominal</label>
                                    <input name="nominal" class="form-control" type="text" value="{{ old('nominal') }}">
                                    @error('nominal')
    ...
    @foreach ($pilihan as $item)
        <div class="modal fade" id="update{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Target Bonus</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ url('/admin/pilihan-cepat/update/' . $item->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">Nominal</label>
                                        <input name="nominal" class="form-control" type="text"
                                            value="{{ $item->nominal }}">
                                        @error('nominal')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
    ...
    @foreach ($pilihan as $item)
        <div class="modal fade" id="delete{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Delete Pilihan Cepat {{ $item->nama_lengkap }}
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ url('/admin/pilihan-cepat/delete/' . $item->id) }}" method="Post">
                            @csrf
                            @method('DELETE')
